...
(function(){
  ...
  window.GradientEditor = GradientEditor = function(opt){
    ...
    this.avg = {
      l: this.colors.map(function(it){
        return ldColor.hcl(it).l;
      }).reduce(function(a, b){
        return a + b;
    ...
    this.root.addEventListener('mouseover', function(e){
      ...
      if (e.target.parentNode.parentNode === this$.el.colors) {
        return this$.setIdx(+e.target.parentNode.getAttribute('data-idx'));
      }
    });
  ...
  GradientEditor.prototype = import$(Object.create(Object.prototype), {
    ...
    getCss: function(){
      var stops;
      stops = this.colors.map(function(it){
        return ldColor.hex(it) + " " + it.offset * 100 + "%";
      }).join(',');
      return ".gradient-" + (this.name || this.id) + " {\n  background: linear-gradient(" + this.dir + "deg," + stops + ");\n}";
    },
    getSvg: function(){
      var stops, x1, y1, x2, y2;
      stops = this.colors.map(function(it){
        return "<stop stop-color=\"" + ldColor.hex(it) + "\" offset=\"" + it.offset + "\"/>";
      }).join('');
      x1 = 0.5 + 0.5 * Math.cos(this.dir * Math.PI / 180);
      y1 = 0.5 + 0.5 * Math.sin(this.dir * Math.PI / 180);
      x2 = 0.5 + 0.5 * Math.cos((this.dir + 180) * Math.PI / 180);
      y2 = 0.5 + 0.5 * Math.sin((this.dir + 180) * Math.PI / 180);
      return "<?xml version=\"1.0\">\n<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 100 100\">\n<linearGradient id=\"gradient-" + (this.name || this.id) + "\" x1=\"" + x1 + "\" y1=\"" + y1 + "\" x2=\"" + x2 + "\" y2=\"" + y2 + "\">" + stops + "</linearGradient>\n<rect x=\"0\" y=\"0\" width=\"100\" height=\"100\" fill=\"url(#gradient-" + (this.name || this.id) + ")\"/>\n</svg> ";
    },
    build: function(){
      return this.root.innerHTML = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"-10 10 120 120\" preserveAspectRatio=\"xMidYMid\">\n  <linearGradient id=\"" + this.id + "-gradient\" x1=\"0\" x2=\"1\" y1=\"0\" y2=\"0\"></linearGradient>\n  <path class=\"ldg-bar\" d=\"M-1.962 80 A60 60 1 0 0 101.962 80\" fill=\"none\" stroke=\"#eeeff1\" stroke-width=\"1\"/>\n  <g class=\"ldg-board\" transform=\"rotate(" + this.dir + " 50 50)\">\n    <circle cx=\"50\" cy=\"50\" r=\"50\" fill=\"url(#" + this.id + "-gradient)\"/>\n    <use href=\"#ldg-knob-" + (this.avg.l > 80 ? 'dark' : 'light') + "\"/>\n  </g>\n  <g class=\"ldg-texts\" transform=\"translate(50 50)\">\n    <text class=\"ldg-hex\" dx=\"-0.2em\" dy=\"-0.7em\"></text>\n    <text dx=\"0.1em\" dy=\"0.6em\">\n      <tspan class=\"ldg-percent\"></tspan><tspan font-size=\"0.7em\">%</tspan>\n    </text>\n    <text dy=\"1.4em\" class=\"ldg-btn\">\n      <tspan data-action=\"dup\">+ </tspan><tspan data-action=\"del\"> &times;</tspan>\n    </text>\n  </g>\n  <g class=\"ldg-colors\"></g>\n</svg>";
    },
